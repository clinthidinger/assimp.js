...
{   
    class_<aiMatrix4x4>("aiMatrix4x4")
        ...
        .function("op_mult_mat", select_overload<aiMatrix4x4t<TReal> (const aiMatrix4x4t<TReal>&) const>(&aiMatrix4x4::operator*))
        .function("op_mult_scalar", select_overload<aiMatrix4x4t<TReal> (const TReal&) const>(&aiMatrix4x4::operator*))
        ...
        .function("decomposeEulerRot", select_overload<void (aiVector3t<TReal>&, aiVector3t<TReal>&, aiVector3t<TReal>&) const>(&aiMatrix4x4::Decompose))
        .function("decomposeQuatRot", select_overload<void (aiVector3t<TReal>&, aiQuaterniont<TReal>&, aiVector3t<TReal>&) const>(&aiMatrix4x4::Decompose))
        .function("decomposeAngleAxisRot", select_overload<void (aiVector3t<TReal>&, aiVector3t<TReal>&, TReal&, aiVector3t<TReal>&) const>(&aiMatrix4x4::Decompose))
